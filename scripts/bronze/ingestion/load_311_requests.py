...
# ============================================================
# Bronze Loader: 311 Service Requests
#
# Reads raw Parquet files from S3 landing zone using Databricks
# Autoloader (cloudFiles) and appends to Bronze Delta table.
#
# Source      : s3://nyc-lakehouse-store/raw/311/
# Target      : {catalog}.bronze.311_requests
# Dataset     : NYC Open Data -- erm2-nwe9
# Primary Key : unique_key (dedup handled in dbt Staging)
...
# -- Widgets -----------------------------------------------
# All paths are parameterized so the same notebook works
...
CHECKPOINT_PATH = "s3://nyc-lakehouse-store/checkpoints/bronze/311_requests/"
